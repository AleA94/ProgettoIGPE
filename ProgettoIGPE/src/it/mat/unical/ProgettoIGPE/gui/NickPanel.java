...
public class NickPanel extends JPanel {
	...
	int xmp = width / 2 + 580;// coordinate multiplayer
	int ymp = height / 2 + 450;

	int xsp = width / 2 + 380;// coordinate singleP
	int ysp = height / 2 + 230;

	int xlg = width / 2 + 780;// coordinate load game
	int ylg = height / 2 + 230;
	...
	public void paintComponent(Graphics g) {
		...
		g.drawImage(ImageLoader.getBorderNick(), (width / 2) - 250, 0, 450, 300, null);
	}
}
