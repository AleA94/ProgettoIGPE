...
public class DialogBackgroundsPanel extends JPanel {
	...
	public DialogBackgroundsPanel(MainFrame frame, CentralEditorPanel c, EditorPanel ep) {
		...
		firstBackground
				.setIcon(new ImageIcon(ImageLoader.getBackground().getScaledInstance(131, 115, Image.SCALE_SMOOTH)));
		firstBackground.setBackground(Color.WHITE);
		firstBackground.setBounds(0, 0, 131, 115);
		...
		secondBG.setIcon(new ImageIcon(ImageLoader.getAutumn().getScaledInstance(150, 115, Image.SCALE_SMOOTH)));
		secondBG.setBounds(131, 0, 131, 115);
		...
		thirdBG.setIcon(new ImageIcon(ImageLoader.getAbstractBG().getScaledInstance(150, 115, Image.SCALE_SMOOTH)));
		thirdBG.setBounds(262, 0, 131, 115);
		...
		this.dialogBG.setMinimumSize(new Dimension((int) (width * 0.3), (int) (height * 0.2)));
		this.dialogBG.setPreferredSize(new Dimension((int) (width * 0.3), (int) (height * 0.2)));
		this.dialogBG.setBounds(begin, this.getHeight() - begin, (int) (width * 0.3), (int) (height * 0.2));
		this.dialogBG.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
		this.dialogBG.setLocation(500, 570);
