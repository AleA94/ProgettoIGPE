...
public class DialogSpawnPanel extends JPanel {
	...
	public DialogSpawnPanel(MainFrame frame, EditorPanel ep) {
		...
		Spawn.setIcon(new ImageIcon(ImageLoader.getSpawner().getScaledInstance(129, 115, Image.SCALE_SMOOTH)));
		Spawn.setBounds(0, 0, 129, 115);
		...
		this.dialogSpawn.setMinimumSize(new Dimension((int) (width * 0.1), (int) (height * 0.2)));
		this.dialogSpawn.setPreferredSize(new Dimension((int) (width * 0.1), (int) (height * 0.2)));
		this.dialogSpawn.setBounds(begin, this.getHeight() - begin, (int) (width * 0.1), (int) (height * 0.2));
		this.dialogSpawn.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
		this.dialogSpawn.setLocation(365, 570);
