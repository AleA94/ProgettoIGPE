...
public class DialogPlayerPanel extends JPanel {
	...
	public DialogPlayerPanel(MainFrame frame, EditorPanel ep, CentralEditorPanel c) {
		...
		firstPlayer.setIcon(new ImageIcon(ImageLoader.getF().getScaledInstance(131, 115, Image.SCALE_SMOOTH)));
		firstPlayer.setBounds(0, 0, 131, 115);
		...
		secondPlayer.setIcon(new ImageIcon(ImageLoader.getG().getScaledInstance(131, 115, Image.SCALE_SMOOTH)));
		secondPlayer.setBounds(131, 0, 131, 115);
		...
		thirdPlayer.setIcon(new ImageIcon(ImageLoader.getM().getScaledInstance(131, 115, Image.SCALE_SMOOTH)));
		thirdPlayer.setBounds(262, 0, 131, 115);
		...
		this.dialog.setMinimumSize(new Dimension((int) (width * 0.3), (int) (height * 0.2)));
		this.dialog.setPreferredSize(new Dimension((int) (width * 0.3), (int) (height * 0.2)));
		this.dialog.setBounds(begin, this.getHeight() - begin, (int) (width * 0.3), (int) (height * 0.2));
		this.dialog.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
		this.dialog.setLocation(50, 570);
